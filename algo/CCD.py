...
from rotation import rotate_vector, vec_mult_vec #(point1, point2, vec, angle)
from math import acos, sqrt, atan2

from ..geometry.transform import calcnewcord
			...
			if i1 != 0:
				...
				for res in residues:
					for atom in res:
						...
						atom.set_coord(calcnewcord(N_vec, CA_vec, coord, angle))
				...
				for res in residues:
					...
					for atom in res:
						coord = atom.get_vector()
						atom.set_coord(calcnewcord(CA_vec, C_vec, coord, angle))
