...
class Quaternion:
    ...
    def from_axistrig(sind, cosd, v):
        v = normalize(v)

        new_quaternion = Quaternion()
        new_quaternion._axistrig_to_q(sind, cosd, v)
    ...
    def _axistrig_to_q(self, sind, cosd, v):
        x = v[0]
        y = v[1]
        z = v[2]
    ...
    def __mul__(self, b):
        ...
        if isinstance(b, Quaternion):
            ...
            if len(b) != 3:
                raise ValueError("Input vector has invalid length " + str(len(b)))
